...
namespace Core
{
	...
	public class ElementsLinkedList<T> : ObservableCollection<T>, ICollection<T>, IEnumerable<T>, IEnumerable, ICollection, IReadOnlyCollection<T>, ISerializable, IDeserializationCallback where T : IElement
	{
		...
		public struct Enumerator : IEnumerator<T>, IDisposable, IEnumerator, ISerializable, IDeserializationCallback
		{
			...
			private ElementsLinkedListNode<T> enumhead;
			...
			void IDeserializationCallback.OnDeserialization(object sender)
			{
				...
				enumlist = (ElementsLinkedList<T>)siInfo.GetValue("CustomLinkedList", typeof(ElementsLinkedList<T>));
		...
		internal ElementsLinkedListNode<T> head;
        ...
        /// <returns>The first <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> of the <see cref="T:Core.CustomLinkedList<T>" />.</returns>

        public ElementsLinkedListNode<T> First
		{
		...
		/// <returns>The last <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> of the <see cref="T:Core.CustomLinkedList<T>" />.</returns>
		
		public ElementsLinkedListNode<T> Last
		{
        ...
        public ElementsLinkedList() : base()
		{
		}
		...
		public ElementsLinkedList(IEnumerable<T> collection) : base(collection)
		{
			if (collection == null)
			{
		...
		protected ElementsLinkedList(SerializationInfo info, StreamingContext context) : base()
		{
			siInfo = info;
		}
        ...
        /// <param name="node">The <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> after which to insert a new <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> containing <paramref name="value" />.</param>
        /// <param name="value">The value to add to the <see cref="T:Core.CustomLinkedList<T>" />.</param>
        /// <returns>The new <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> containing <paramref name="value" />.</returns>
        /// <exception cref="T:System.ArgumentNullException">
        ...
        private ElementsLinkedListNode<T> AddAfter(ElementsLinkedListNode<T> node, T value)
		{
			ValidateNode(node);
			ElementsLinkedListNode<T> ElementsLinkedListNode = new ElementsLinkedListNode<T>(node.list, value);
			InternalInsertNodeBefore(node.next, ElementsLinkedListNode);
		...
		/// <param name="node">The <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> after which to insert <paramref name="newNode" />.</param>
		/// <param name="newNode">The new <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> to add to the <see cref="T:Core.CustomLinkedList<T>" />.</param>
		/// <exception cref="T:System.ArgumentNullException">
		...
		private void AddAfter(ElementsLinkedListNode<T> node, ElementsLinkedListNode<T> newNode)
		{
			ValidateNode(node);
		...
		/// <param name="node">The <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> before which to insert a new <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> containing <paramref name="value" />.</param>
		/// <param name="value">The value to add to the <see cref="T:Core.CustomLinkedList<T>" />.</param>
		/// <returns>The new <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> containing <paramref name="value" />.</returns>
		/// <exception cref="T:System.ArgumentNullException">
		///   <paramref name="node" /> is <see langword="null" />.</exception>
		...
		private ElementsLinkedListNode<T> AddBefore(ElementsLinkedListNode<T> node, T value)
		{
			ValidateNode(node);
			ElementsLinkedListNode<T> ElementsLinkedListNode = new ElementsLinkedListNode<T>(node.list, value);
			InternalInsertNodeBefore(node, ElementsLinkedListNode);
			if (node == head)
			{
				head = ElementsLinkedListNode;
			}
			return ElementsLinkedListNode;
		}

		/// <summary>Adds the specified new node before the specified existing node in the <see cref="T:Core.CustomLinkedList<T>" />.</summary>
		/// <param name="node">The <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> before which to insert <paramref name="newNode" />.</param>
		/// <param name="newNode">The new <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> to add to the <see cref="T:Core.CustomLinkedList<T>" />.</param>
		/// <exception cref="T:System.ArgumentNullException">
		///   <paramref name="node" /> is <see langword="null" />.  
		/// -or-  
		...
		private void AddBefore(ElementsLinkedListNode<T> node, ElementsLinkedListNode<T> newNode)
		{
			ValidateNode(node);
			ValidateNewNode(newNode);
		...
		private ElementsLinkedListNode<T> AddFirst(T value)
		{
			ElementsLinkedListNode<T> ElementsLinkedListNode = new ElementsLinkedListNode<T>(this, value);
			if (head == null)
			{
				InternalInsertNodeToEmptyList(ElementsLinkedListNode);
			}
			else
			{
				InternalInsertNodeBefore(head, ElementsLinkedListNode);
				head = ElementsLinkedListNode;
			}
			return ElementsLinkedListNode;
		}
		...
		/// <param name="node">The new <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> to add at the start of the <see cref="T:Core.CustomLinkedList<T>" />.</param>
		/// <exception cref="T:System.ArgumentNullException">
		///   <paramref name="node" /> is <see langword="null" />.</exception>
		/// <exception cref="T:System.InvalidOperationException">
		///   <paramref name="node" /> belongs to another <see cref="T:Core.CustomLinkedList<T>" />.</exception>

		private void AddFirst(ElementsLinkedListNode<T> node)
		{
		...
		private ElementsLinkedListNode<T> AddLast(T value)
		{
			ElementsLinkedListNode<T> ElementsLinkedListNode = new ElementsLinkedListNode<T>(this, value);
			if (head == null)
			{
		...
		/// <param name="node">The new <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> to add at the end of the <see cref="T:Core.CustomLinkedList<T>" />.</param>
		/// <exception cref="T:System.ArgumentNullException">
		///   <paramref name="node" /> is <see langword="null" />.</exception>
		/// <exception cref="T:System.InvalidOperationException">
		///   <paramref name="node" /> belongs to another <see cref="T:Core.CustomLinkedList<T>" />.</exception>

		private void AddLast(ElementsLinkedListNode<T> node)
		{
			ValidateNewNode(node);
			if (head == null)
			{
		...
		/// <param name="node">The <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> to remove from the <see cref="T:Core.CustomLinkedList<T>" />.</param>
		/// <exception cref="T:System.ArgumentNullException">
		///   <paramref name="node" /> is <see langword="null" />.</exception>
		/// <exception cref="T:System.InvalidOperationException">
		///   <paramref name="node" /> is not in the current <see cref="T:Core.CustomLinkedList<T>" />.</exception>

		private void Remove(ElementsLinkedListNode<T> node)
		{
			ValidateNode(node);
		...
		{
            ElementsLinkedListNode<T> next = head;
			while (next != null)
			{
				ElementsLinkedListNode<T> ElementsLinkedListNode = next;
				next = next.Next;
				ElementsLinkedListNode.Invalidate();
			}
			head = null;
			count = 0;
			version++;
		...
		{
			ElementsLinkedListNode<T> ElementsLinkedListNode = Find(value);
		...
		/// <summary>
		/// Gets the <see cref="T:Core.ElementsLinkedListNode<T>"/> at the given Index.
		/// </summary>
		...
		/// <returns>The first <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> that contains the specified value, if found; otherwise, <see langword="null" />.</returns>
		...
		public ElementsLinkedListNode<T> Find(Guid id)
		{
			ElementsLinkedListNode<T> next = head;
			if (next != null)
			{
		...
		/// <param name="value">The value to locate in the <see cref="T:Core.CustomLinkedList<T>" />.</param>
		/// <returns>The last <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> that contains the specified value, if found; otherwise, <see langword="null" />.</returns>
		...
		public ElementsLinkedListNode<T> FindLast(Guid id)
		{
			if (head == null)
			{
				return null;
			}
			ElementsLinkedListNode<T> prev = head.prev;
			ElementsLinkedListNode<T> ElementsLinkedListNode = prev;
			if (ElementsLinkedListNode != null)
			{
				if (id != Guid.Empty)
				{
					do
					{
						...
						ElementsLinkedListNode = ElementsLinkedListNode.prev;
					}
					while (ElementsLinkedListNode != prev);
				}
				else
				{
					do
					{
						if (ElementsLinkedListNode.item == null)
						{
							return ElementsLinkedListNode;
						}
						ElementsLinkedListNode = ElementsLinkedListNode.prev;
        ...
        private void InternalInsertNodeBefore(ElementsLinkedListNode<T> node, ElementsLinkedListNode<T> newNode)
		{
			newNode.next = node;
		...
		private void InternalInsertNodeToEmptyList(ElementsLinkedListNode<T> newNode)
		{
		...
		internal void InternalRemoveNode(ElementsLinkedListNode<T> node)
		{
			if (node.next == node)
			{
				head = null;
		...
		internal void ValidateNewNode(ElementsLinkedListNode<T> node)
		{
			if (node == null)
			{
		...
		internal void ValidateNode(ElementsLinkedListNode<T> node)
		{
			if (node == null)
			{
				throw new ArgumentNullException("node");
    ...
    /// <typeparam name="T">Specifies the element type of the linked list.</typeparam>
    [ComVisible(false)]
	public sealed class ElementsLinkedListNode<T> where T : IElement
	{
		internal ElementsLinkedList<T> list;

		internal ElementsLinkedListNode<T> next;

		internal ElementsLinkedListNode<T> prev;

		internal T item;

		/// <summary>Gets the <see cref="T:Core.CustomLinkedList<T>" /> that the <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> belongs to.</summary>
		/// <returns>A reference to the <see cref="T:Core.CustomLinkedList<T>" /> that the <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> belongs to, or <see langword="null" /> if the <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> is not linked.</returns>
		
		public ElementsLinkedList<T> List
		{
		...
		public ElementsLinkedListNode<T> Next
		{
		...
		public ElementsLinkedListNode<T> Previous
		{
		...
		/// <summary>Initializes a new instance of the <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" /> class, containing the specified value.</summary>
		/// <param name="value">The value to contain in the <see cref="T:System.Collections.Generic.ElementsLinkedListNode`1" />.</param>
		
		public ElementsLinkedListNode(T value)
		{
			item = value;
		}

		internal ElementsLinkedListNode(ElementsLinkedList<T> list, T value)
		{
			this.list = list;
			item = value;
		}
